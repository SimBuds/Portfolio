...
export const WORK: WorkItem[] = [
  {
    ...
    summary: "Sole developer and client contact for a custom jewelry brand's move into e-commerce: migrated the site, catalog, URL redirects, and AWS-hosted media from WordPress to Shopify, preserving indexed URLs and baseline organic traffic through a full 301 redirect map for the platform-forced URL changes and post-launch index coverage checks in Search Console, then launched a 16-page storefront on a customized Dawn 2.0 theme. In its Liquid templates I implemented the title tags, meta descriptions, heading structure, and JSON-LD structured data. Built an LLM content pipeline that drafts product descriptions and content briefs for the client's editorial team to review, then audits published output and scores it against target keywords — cutting drafting time from 30 minutes to 5 across a 200+ product catalogue. I own ongoing content operations and on-page technical SEO alongside the client's marketing team, using Search Console, Analytics, and Ads; organic blog traffic is up 30% year over year. A ring-builder configurator is in active development.",
